...
const flow = [
  {
    ...
    desc: "Provide age, city and number of family members to get started.",
    icon: ClipboardList,
  },
  {
    id: 2,
    title: "Add Family Members",
    desc: "Select self, spouse, children or parents you want to insure.",
    icon: Users,
  },
  {
    id: 3,
    title: "Compare Health Plans",
    desc: "Compare plans from top insurers with coverage & benefits.",
    icon: Sliders,
  },
  {
    id: 4,
    title: "Choose Add-ons (Optional)",
    desc: "Enhance coverage with add-ons like OPD, maternity or PED cover.",
    icon: ShieldCheck,
  },
  {
    id: 5,
    title: "Secure Payment & Policy Issuance",
    desc: "Complete payment online and receive your policy instantly.",
    icon: CreditCard,
  },
];

export default function HealthInsuranceFlowGuide() {
  return (
    <div className="min-h-screen bg-[#C3ECFE] py-24 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-32">
          <div className="bg-white/70 backdrop-blur-xl border border-white/70 rounded-[32px] px-10 py-14 shadow-[0_25px_60px_-30px_rgba(30,90,150,0.5)]">
            ...
            <p className="text-center text-sm text-slate-500">
              Comprehensive health protection for you & your family
            </p>
            ...
            <div className="mt-6 flex flex-wrap justify-center gap-6 text-sm text-slate-600">
              ...
              <div className="flex items-center gap-2">
                ...
                Compare top health insurers
              </div>
              <div className="flex items-center gap-2">
                <HeartPulse className="w-4 h-4" style={{ color: BRAND_BLUE }} />
            ...
            <p className="mt-4 text-center text-sm text-slate-500">
              Looking for a family floater plan?{" "}
              <span
        ...
        >
          Steps to Buy Health Insurance from DigiBima
        </motion.h1>

        <p className="text-center text-slate-600 max-w-2xl mx-auto mt-4">
          A smooth, paperless and fully digital health insurance journey.
        </p>
        ...
        <div className="mt-32 text-center">
          ...
          <p className="text-sm text-slate-500 mt-3 flex items-center justify-center gap-2">
            ...
            Instant policy & cashless hospitals
          </p>
        </div>
      </div>
    </div>
