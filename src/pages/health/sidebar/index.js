...
import GotoMotor from "@/components/gotomotor";
...
const router = useRouter();
  ...
  const updatePincode = async () => {
    ...
    try {
      ...
      if (res?.status) {
        ...
        if (String(displayedPincode) !== String(pincode)) {
          await clearDBData();
        }
  ...
  return (
    <div className="md:col-span-3">
      <div className="bg-white border rounded-[30px] shadow-md p-4 mb-10">
              ...
              <div className="divide-y divide-gray-200">
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="bg-blue-50 p-2 rounded-full">
                     <Image
                        src="/images/health/illness-one.png"
                        alt="Illness"
                         width={32}
                         height={32}
                      />
