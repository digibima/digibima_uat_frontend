...
const updatePincodeMutation = useMutation({
  mutationFn: (payload) =>
    CallApi(constant.API.HEALTH.UPDATEPINCODE, "POST", payload),
  onSuccess: () => {
  ...
  onError: () => showError("Something went wrong while updating pincode."),
});
