...
export default function StepFourForm({
  ...
  const medicalHistory = parsedPed.filter(
    (item) =>
      ...
      !(planType == 2 && item.code == "504")
  );

  const lifestyleHistory = parsedPed.filter((item) =>
    planType == 1 ? item.did?.startsWith("3.") : item.code === "504"
  );
                  ...
                  >
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full text-sm">
                        ...
                        <tbody>
                          <tr className="border-t hover:bg-red-50/30 transition">
                  ...
                  >
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full text-sm">
                        ...
                        <tbody>
                          <tr className="border-t hover:bg-yellow-50/30 transition">
                            <td className="px-4 py-4">
                              <span className="bg-gray-100 text-gray-700 px-3 py-1 rounded-full text-xs font-medium">
                                {item.name || proposer.name || "N/A"}
                              </span>
